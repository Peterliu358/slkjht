...
export default {
  ...
  mounted() {
    ...
    this.axios
      .get(
        this.$store.state.host + "album/getAlbumTree?appcode=" + this.appcode
      )
      .then((response) => {
    ...
    this.axios
      .get(
        this.$store.state.host +
          "album/getAlbumByParentCode?appcode=" +
          this.appcode +
          "&parentCode=0"
      )
      .then((response) => {
  ...
  methods: {
    ...
    getCourseData() {
      this.axios
        ...
        .then((response) => {
          ...
          this.online = true;
          this.input = "";
          this.courseUrl = response.data.rowData[0].object.name;
          this.dataLength = response.data.rowCount;
        })
        .catch((error) => {
          console.log(error);
    ...
    handleDelete(index, row) {
      this.axios
        .get(this.$store.state.host + "album/delAlbum?id=" + row.id)
        .then((response) => {
          this.$message({
            message: "删除成功",
            type: "success",
...
<style src="@/assets/css/specoal.scss" scoped lang="scss">
</style>